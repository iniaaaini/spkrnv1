...
class _HomeScreenState extends State<HomeScreen> {
  ...
  int smoke = 0;
  double viscosity = 50.0; // Nilai default untuk kekentalan
    ...
    _sensorRef.onValue.listen((DatabaseEvent event) {
      ...
      if (data != null) {
        setState(() {
          ...
          // Jika ada data kekentalan di Firebase, bisa ditambahkan di sini
          // viscosity = double.tryParse(data['viscosity'].toString()) ?? 50.0;
        });
      }
    }, onError: (error) {
                        ...
                        children: [
                          Padding(
                            ...
                            child: SizedBox(
                              width: 41,
                              height: 41,
                              child: Image.asset('assets/suhu.png'),
                            ),
                          ),
                          Column(
                        ...
                        children: [
                          Padding(
                            ...
                            child: SizedBox(
                              width: 41,
                              height: 41,
                              child: Image.asset('assets/asap.png'),
                            ),
                          ),
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
...
// [Bagian SpeedControlCard, VerticalLineThumbShape, dan SeparatedTrackShape tetap sama persis dengan kode asli Anda]
